...
def test_upload_patch_to_s3_prefers_explicit_patch_key(monkeypatch: pytest.MonkeyPatch) -> None:
    import esprit.runtime as rt_module
    ...
    rt_module._upload_patch_to_s3("diff-content", MagicMock())
...
def test_upload_patch_to_s3_falls_back_to_legacy_key(monkeypatch: pytest.MonkeyPatch) -> None:
    import esprit.runtime as rt_module
