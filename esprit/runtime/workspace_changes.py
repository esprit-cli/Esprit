...
def collect_workspace_changes(
    ...
    prefix = _common_prefix(all_rel_paths)
    ...
    for rel_path in all_rel_paths:
        ...
        if before_path:
            before_text, before_binary = _read_text(before_path)
        if after_path:
            after_text, after_binary = _read_text(after_path)

        if before_path and after_path and not before_binary and not after_binary and before_text == after_text:
            continue
