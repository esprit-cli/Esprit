...
AVAILABLE_MODELS: dict[str, list[ModelEntry]] = {
    ...
    "anthropic": [
        ("claude-sonnet-4-5-20250514", "Claude Sonnet 4.5", 3.0, 15.0, 200_000),
        ("claude-opus-4-5-20251101", "Claude Opus 4.5", 15.0, 75.0, 200_000),
        ("claude-haiku-4-5-20251001", "Claude Haiku 4.5", 0.80, 4.0, 200_000),
    ],
    "openai": [
