...
Skip the setup. Run Esprit in the cloud at [esprit.dev](https://esprit.dev).
...
1. Sign up at [esprit.dev](https://esprit.dev)
2. Connect your repository or enter a target URL
3. Launch your first scan

<Card title="Try Esprit Cloud" icon="rocket" href="https://esprit.dev">
