---
title: "Azure OpenAI"
description: "Configure Esprit with OpenAI models via Azure"
---

## Setup

```bash
export ESPRIT_LLM="azure/your-gpt5-deployment"
...
|----------|-------------|
| `ESPRIT_LLM` | `azure/<your-deployment-name>` |
...
```bash
export ESPRIT_LLM="azure/gpt-5-deployment"
