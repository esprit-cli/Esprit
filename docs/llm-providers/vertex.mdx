...
description: "Configure Esprit with Gemini models via Google Cloud"
---

## Installation

Vertex AI requires the Google Cloud dependency. Install Esprit with the vertex extra:

```bash
pipx install "esprit-agent[vertex]"
```

## Setup

```bash
export ESPRIT_LLM="vertex_ai/gemini-3-pro-preview"
```
