...
Skills are structured knowledge packages that give Esprit agents deep expertise in specific vulnerability types, technologies, and testing methodologies.
...
When Esprit spawns an agent for a specific task, it selects up to 5 relevant skills based on the context:
