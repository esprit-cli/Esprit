...
description: "Guide Esprit with custom testing instructions"
---
...
```bash
esprit --target https://app.com --instruction "Focus on authentication vulnerabilities"
```
...
```bash
esprit --target https://app.com --instruction-file ./pentest-instructions.md
```
...
```bash
esprit --target https://api.example.com \
...
<Tip>
Be specific. Good instructions help Esprit prioritize the most valuable attack paths.
</Tip>
