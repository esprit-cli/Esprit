...
```bash
esprit scan https://app.com --instruction "Focus on authentication vulnerabilities"
```
...
```bash
esprit scan https://app.com --instruction-file ./pentest-instructions.md
```
