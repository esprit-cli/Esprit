...
Esprit offers three scan modes to balance speed and thoroughness.

## Quick

```bash
esprit --target ./app --scan-mode quick
```
...
```bash
esprit --target ./app --scan-mode standard
```
...
```bash
esprit --target ./app --scan-mode deep
```
